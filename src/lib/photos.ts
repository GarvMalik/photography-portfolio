...
export const PHOTOS: Photo[] = [
  ...
  { slug: "frame-09", src: "/images/spain/spain-29.jpg",       ratio: "3/4", label: "Casa Batlló", type: "Architecture",  series: "Barcelona", alt: "The undulating Modernisme facade of Casa Batlló" },
];
